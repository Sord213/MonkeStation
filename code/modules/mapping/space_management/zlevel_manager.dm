...
/datum/controller/subsystem/mapping/proc/add_new_zlevel(name, traits = list(), z_type = /datum/space_level, orbital_body_type, sunshine = TRUE)
	...
	var/datum/space_level/S = new z_type(new_z, name, traits, orbital_body_type, sunshines = sunshine)
	z_list += S
	return S
