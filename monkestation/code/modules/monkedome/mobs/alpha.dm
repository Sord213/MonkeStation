/mob/living/simple_animal/hostile/jungleland/alpha_meduracha
...
/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/Initialize()
	. = ..()
	for(var/side in anchors)
		anchors[side] = get_beam()

/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/Move(atom/newloc, dir, step_x, step_y)
...
/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/Shoot(atom/targeted_atom)
	. = ..()
...
/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/proc/shoot_projectile(atom/targeted_atom)
...
/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/proc/get_beam()
	...
	return Beam(T,"meduracha",'monkestation/icons/effects/beam.dmi',INFINITY,8)

/mob/living/simple_animal/hostile/jungleland/alpha_meduracha/proc/remake_beam(side)
	var/datum/beam/B = anchors[side]
	anchors[side] = get_beam()
	qdel(B)

/mob/living/simple_animal/hostile/jungleland/alpha_blobby
...
/mob/living/simple_animal/hostile/jungleland/alpha_blobby/attacked_by(obj/item/I, mob/living/user)
	. = ..()
	if((stage == 1 && health <= 300) || (stage == 2 && health <= 200) || (stage == 3 && health <= 100))
		increment_stage()
		return

/mob/living/simple_animal/hostile/jungleland/alpha_blobby/proc/increment_stage()
	if(!target)
		return
	var/mob/living/simple_animal/hostile/A = new /mob/living/simple_animal/hostile/jungleland/blobby(get_step(src,turn(get_dir(src,target),90)),4 - stage)
	var/mob/living/simple_animal/hostile/B = new /mob/living/simple_animal/hostile/jungleland/blobby(get_step(src,turn(get_dir(src,target),-90)),4 - stage)
