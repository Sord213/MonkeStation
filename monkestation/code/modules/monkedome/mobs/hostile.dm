...
/mob/living/simple_animal/hostile/jungleland //jungleland and not just jungle because TG has some mobs under /jungle/ that i dont want to fuck with and override (they are unused, but like whats the point..)
...
/mob/living/simple_animal/hostile/jungleland/attacked_by(obj/item/I, mob/living/user)
...
/mob/living/simple_animal/hostile/jungleland/dryad/Shoot(atom/targeted_atom)
...
/mob/living/simple_animal/hostile/jungleland/corrupted_dryad
...
/mob/living/simple_animal/hostile/jungleland/meduracha
	...
	alpha_type = /mob/living/simple_animal/hostile/jungleland/alpha_meduracha

	var/sulking = FALSE

/mob/living/simple_animal/hostile/jungleland/meduracha/Initialize()
	. = ..()
	RegisterSignal(src,COMSIG_MOVABLE_MOVED,.proc/on_sulking)

/mob/living/simple_animal/hostile/jungleland/meduracha/AttackingTarget()
	. = ..()
...
/mob/living/simple_animal/hostile/jungleland/meduracha/Goto(target, delay, minimum_distance)
	update_sulking(TRUE)
	return ..()


/mob/living/simple_animal/hostile/jungleland/meduracha/LoseAggro()
	update_sulking(TRUE)
	return ..()

/mob/living/simple_animal/hostile/jungleland/meduracha/proc/update_sulking(bool)
	sulking = bool
	on_sulking()

/mob/living/simple_animal/hostile/jungleland/meduracha/proc/on_sulking()
	if(stat != CONSCIOUS)
		return
...
/mob/living/simple_animal/hostile/jungleland/skin_twister
	name = "Skin twister"
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/AttackingTarget()
	. = ..()
	if(victim_ref)
		reveal_true_form()
	if(isliving(target))
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/Life()
	. = ..()
	if(!.) //dead
		return
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/proc/steal_identity(mob/living/victim)
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/proc/reveal_true_form()
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/proc/pick_lure()
	var/mob/living/picked = pick(subtypesof(/mob/living/simple_animal/hostile/jungleland))
...
/mob/living/simple_animal/hostile/jungleland/skin_twister/proc/lure()
	if(!human_lure)
		return
...
/mob/living/simple_animal/hostile/jungleland/blobby
	name = "Blobby"
...
/mob/living/simple_animal/hostile/jungleland/blobby/death(gibbed)
	if(current_size > 1  && !gibbed)
		...
		for(var/turf/T in RANGE_TURFS(1,src))
			if(isclosedturf(T))
				continue
			possible_spawns += T
		var/mob/living/simple_animal/hostile/A =  new /mob/living/simple_animal/hostile/jungleland/blobby(pick(possible_spawns),current_size - 1)
		var/mob/living/simple_animal/hostile/B = new /mob/living/simple_animal/hostile/jungleland/blobby(pick(possible_spawns),current_size - 1)
		if(target)
			A.FindTarget(list(target))
			B.FindTarget(list(target))
	return ..()

/mob/living/simple_animal/hostile/jungleland/mosquito
	name = "Giant Mosquito"
...
/mob/living/simple_animal/hostile/jungleland/mosquito/Goto(target, delay, minimum_distance)
...
/mob/living/simple_animal/hostile/jungleland/mosquito/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	. = ..()
	charging = FALSE
	if(!ishuman(hit_atom))
...
/mob/living/simple_animal/hostile/jungleland/mosquito/attacked_by(obj/item/I, mob/living/user)
	. = ..()
	if(!awoke && stat != DEAD)
		toggle_ai(AI_ON)
		awoke = TRUE
...
/mob/living/simple_animal/hostile/jungleland/mosquito/proc/prepare_charge()
	if(!get_charge())
		return FALSE
...
/mob/living/simple_animal/hostile/jungleland/mosquito/proc/reset_charge()
	can_charge = TRUE

/mob/living/simple_animal/hostile/jungleland/mosquito/proc/use_charge()
	can_charge = FALSE
...
/mob/living/simple_animal/hostile/jungleland/yellowjacket
	...
	icon = 'monkestation/icons/mob/jungle/wasp.dmi'
	icon_state = "wasp"
	icon_living = "wasp"
	icon_dead = "wasp_dead"
...
/mob/living/simple_animal/hostile/jungleland/yellowjacket/AttackingTarget()
	..()
	if(isliving(target))
...
/mob/living/simple_animal/hostile/jungleland/yellowjacket/OpenFire()
	if(charging)
		return
...
/mob/living/simple_animal/hostile/jungleland/yellowjacket/Aggro()
	vision_range = aggro_vision_range

/mob/living/simple_animal/hostile/jungleland/yellowjacket/proc/charge(var/atom/chargeat = target, var/delay = 5)
	if(!chargeat)
		return
...
/mob/living/simple_animal/hostile/jungleland/yellowjacket/Move()
	if(revving_charge)
		return FALSE
	if(charging)
...
/mob/living/simple_animal/hostile/jungleland/emeraldspider
	name = "emerald spider"
...
/mob/living/simple_animal/hostile/obsidian_demon
	...
	icon = 'monkestation/icons/mob/jungle64x64.dmi'
	health = 500
	maxHealth = 500
	pixel_x = -16
	pixel_y = -16
