...
/obj/effect/better_animated_temp_visual/skin_twister_in
	...
	duration = 8
	icon = 'monkestation/icons/effects/64x64.dmi'
...
/obj/effect/tar_king/rune_attack
	icon = 'monkestation/icons/effects/160x160.dmi'
	pixel_x = -64
	pixel_y = -64
...
/obj/effect/timed_attack/tar_priest
	icon = 'monkestation/icons/effects/jungle.dmi'
	animation_length = 13
...
/obj/structure/tar_altar
	...
	icon = 'monkestation/icons/obj/jungle32x48.dmi'
...
/obj/structure/herb/liberal_hats
	...
	picked_amt = 3
	picked_result = /obj/item/food/grown/jungle/liberal_hat
...
/obj/structure/herb/cinchona
	...
	icon_state = "herb_5"
	picked_amt = 3
	picked_result = /obj/item/food/grown/jungle/cinchona_bark
...
/obj/structure/herb/fruit/Initialize()
	...
	switch(fruit)
		if("kuku")
			...
			picked_result = /obj/item/food/grown/jungle/kuku
		if("bonji")
			name = "Bonji bush"
			icon_state = "bonji_plant"
			picked_result = /obj/item/food/grown/jungle/bonji
		if("bianco")
			name = "Bianco bush"
			icon_state = "bianco_plant"
			picked_result = /obj/item/food/grown/jungle/bianco
...
/obj/structure/spawner/nest/proc/spawn_mother_monster()
	var/mob/living/simple_animal/hostile/jungleland/type = pick(mob_types)
	if(initial(type.alpha_type) == 0)
		var/mob/living/simple_animal/hostile/jungleland/monster = new type(loc)
...
/obj/structure/spawner/nest/jungle
	possible_mob_types = list(/mob/living/simple_animal/hostile/jungleland/dryad, /mob/living/simple_animal/hostile/jungleland/yellowjacket)

/obj/structure/spawner/nest/swamp
	possible_mob_types = list(/mob/living/simple_animal/hostile/jungleland/mosquito,/mob/living/simple_animal/hostile/jungleland/meduracha, /mob/living/simple_animal/hostile/jungleland/blobby)

/obj/structure/spawner/nest/dying
	possible_mob_types = list(/mob/living/simple_animal/hostile/jungleland/corrupted_dryad,/mob/living/simple_animal/hostile/jungleland/mosquito)
